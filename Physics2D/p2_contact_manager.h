...
public:
	...
	std::vector<p2Contact> GetContacts(std::array<p2CircleShape*, p2_Max_Polygons> shapes);
private:
	/// <summary>
	...
	std::vector<p2Contact> Broadphase(std::array<p2CircleShape*, p2_Max_Polygons> shapes);
	/// <summary>
